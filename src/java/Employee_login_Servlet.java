 ...
 */
@WebServlet(urlPatterns = {"/Employee_login_Servlet"})
...
"</div>");
            if(email.equals("abc@rku.ac.in") && password.equals("abc123"))
            {
               ...
               // response.sendRedirect("");
                  out.println("<font style=\"padding-left: 120px;\" color=\"blue\">Login suceesfully..</font>");
...
//                
            ...
            {
                out.println("<font style=\"padding-left: 120px;\" color=\"red\">Username or password is incorrect!</font>");
